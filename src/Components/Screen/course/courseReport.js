...
class table extends Component {
  ...
  render() {
    ...
    // const notStarted =
    //   data &&
    //   data.data.total.filter(
    //     (el) =>
    //       el.department.department_name == this.props.user.department &&
    //       el.status == 1
    //   );
      ...
      data && selectedFilter.name !== "All"
        ? data.filter((d) => {
            if (selectedFilter.name == "Daily") {
              ...
              console.log(selectedFilter.date);
              console.log(
                  ...
                  <tbody>
                    {paginatedData &&
                      paginatedData.map((item, index) => (
                        // console.log(item.id);
                        // console.log(this.getSpecificCourse(item.id)[0]);
                        // console.log(user.department);
                        // return (
                        // console.log(item)
                        <>
                          {/* {this.getSpecificCourse(item.id)[0] && ( */}
                          <tr key={item.id}>
                            <th
